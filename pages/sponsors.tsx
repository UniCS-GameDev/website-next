...
export default function Sponsors({ sponsors, partners }: IndexParams) {
    return (
        <Layout title="Sponsors">
            <div className={styles.banner}>
                <h2>Our Sponsors and Partners</h2>
                <h4>Interested in sponsoring us? <a href="#contact">Contact us</a> to find out more!</h4>
            </div>
            <h2>Partners:</h2>
